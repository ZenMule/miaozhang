...
```{r histogram of scores, fig.width=6, fig.height=3.5, fig.align='center'}
scores |> 
  ggplot(aes(score)) +
...
```{r plot the heterogeneity results, fig.width=6, fig.height=3.5, fig.align='center'}
...
```{r r1 results plotting, fig.width=6, fig.height=3.5, fig.align='center'}
...
```{r plot the threshold, fig.width=6, fig.height=3.5, fig.align='center'}
