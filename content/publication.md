...
- (Revision under review) **Zhang, M.** and Fujinaga-Gordon, K. (2025). An illustration of IPA: Ikema, *Journal of International Phonetic Association*.
- (Major revision) Chodroff, E. and **Zhang, M**. (2025). A crosslinguistic corpus phonetic analysis of intrinsic vowel duration. *Journal of Phonetics*.
- (Under review) **Zhang, M.** and Chodroff E. (2025). The universality of vowel intrinsic F0: A corpus study of cross-linguistic and inter-speaker variability in 75 languages. *PNAS*.
- (In preparation) Han, J-Y., **Zhang, M.**, Wang, T., and Xu, Y. (2025), L3 acquisition of Mandarin Chinese stop consonants by learners with L1 Spanish/Thai and L2 English.
- (In preparation) **Zhang, M**. Preboundary lengthening of monophthongs and diphthongs in Chinese, English and Japanese.
